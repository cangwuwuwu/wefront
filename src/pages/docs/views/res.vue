                ...
                <ul class="ivu-menu ivu-menu-light ivu-menu-vertical" style="width: auto;">
                    <Menu width="310" :active-name="choose" @on-select="chooseRes">
                        <div class="catalogue">软件工程
                            <Button type="primary" style="float:right;" ghost size="large" @click="uploadResModal = true">
                            <Badge text="new">
                                上传资源&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </Badge>
                            </Button>
        ...
        <Modal footer-hide v-model="uploadResModal">
            ...
            <Form ref="formUpRes" :model="upRes" :rules="ruleRes">
                ...
                <FormItem label="资源所属" prop="resType">
                    <Select v-model="upRes.resType" multiple filterable :max-tag-count="3" :max-tag-placeholder="maxTypePlaceholder" style="">
                ...
                <FormItem label="资源描述">
                    <Input v-model="upRes.resDescribe" type="textarea" :autosize="{minRows: 2,maxRows: 4}" :maxlength="200" clearable long placeholder="简单描述资源"/>
                </FormItem>
                <FormItem>
                    <Button type="primary" @click="uploadResBtn('formUpRes')" long :loading="uploadresloading">上传</Button>
                </FormItem>
            </Form>
        </Modal>
    </Row>
...
export default {
    ...
    created() {
        ...
        // console.log(info)
        if (info) {  
            this.upRes.resUploader = JSON.parse(info).data.name
        } else {
