    ...
    <div class="signup">
        ...
        <Form ref="formItem" :model="formItem"  :rules="ruleValidate" :label-width="80">
            ...
            <FormItem label="姓名" prop="name">
                <Input v-model="formItem.name" icon="ios-person-outline" placeholder="真实姓名(非必须)"></Input>
            </FormItem>
            <FormItem label="用户名" prop="username">
                <Input v-model="formItem.username"  placeholder="社区用户名/昵称">
            ...
            <FormItem label="确认密码" prop="repassword">
                <Input v-model="formItem.repassword" icon="ios-lock-outline" type="password" placeholder="确认密码">
                </Input>
            </FormItem>
             <FormItem label="邮箱" prop="email">
                <AutoComplete
                    ...
                    placeholder="邮箱账号">
                    <Option v-for="item in formItem.emailist" :value="item" :key="item">{{ item }}</Option>
                </AutoComplete>
            </FormItem>
            <Row :gutter="16">
                <Col span="18">
                    <FormItem label="验证码" prop="code">
                        <Input v-model="formItem.code" enter-button icon="ios-barcode-outline" placeholder="请输入邮箱收到的验证码"></Input>
                    </FormItem>
                </Col>
                <Col span="6">
            ...
            <Row>
                <Col span="12">
                    <FormItem label="籍贯">
                        <Cascader :data="formItem.provs" v-model="formItem.area" change-on-select></Cascader>
                    </FormItem>
                </Col>
                <Col span="12">
                    <FormItem label="生日">
                        <Row>
                            <DatePicker type="date" placeholder="选择生日" v-model="formItem.date"></DatePicker>
                        </Row>
                    </FormItem>
                </Col>
            </Row>
            <Row :gutter="16">
                <Col span="10">
                    <FormItem label="电话" prop="phone">
                        <Input v-model="formItem.phone" icon="ios-call-outline" placeholder="电话号码"></Input>
                    </FormItem>
                </Col>
                <Col span="14">
                    <FormItem label="物种">
            ...
            <FormItem label="签名/简介" prop="info">
                <Input 
...
export default {
        ...
        return {
            ...
            ruleValidate: {
                    ...
                    code: [
                        ...
                        { type: 'number', message: '验证码格式错误!', trigger: 'change' }
                    ],
                    password: [
    ...
    methods: {
        emailSearch (value) {
            this.formItem.emailist = !value || value.indexOf('@') >= 0 ? [] : [
                value + '@qq.com',
                value + '@sina.com',
                value + '@163.com'
            ];
