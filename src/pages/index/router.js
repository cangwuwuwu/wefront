    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: 'finance-dues',
                    component: () => import('@/pages/index/components/admin/finance-dues.vue'),
                    meta: {
                        title: '会费缴纳-NIT计算机协会',
                    }
                },
                ...
                {
                    path: 'resource-web',
                    component: () => import('@/pages/index/components/admin/resource-web.vue'),
                    meta: {
                ...
                {
                    path: 'resource-audit',
                    component: () => import('@/pages/index/components/admin/resource-audit.vue'),
                    meta: {
