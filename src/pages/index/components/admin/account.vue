    ...
    <div class="overview">
        ...
        <Table border :columns="AccountColumns" :data="AccountInfo" size="large" :loading="loading">
            ...
            <template slot-scope="{ row, index }" slot="stuAuthString">
                <Select :placeholder="row.stuAuthString" :label-in-value="labelInValue" style="width:200px" v-if="editIndex === index" @on-open-change = "onOpenChange"  @on-change="onChange">
